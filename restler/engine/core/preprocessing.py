            ...
            for req in GrammarRequestCollection().request_id_collection[endpoint]:
                ...
                if not resource_gen_req and req.is_resource_generator():
                    ...
                    if Settings().in_smoke_test_mode():
                        ...
                        resource_gen_req.stats.request_text = renderings[-1].sent_request_data_list[-1]
                        resource_gen_req.stats.response_text = renderings.final_request_response.to_str()
